<?php
  ...
  {
    if(@$_GET['demail'] && $_SESSION['key']=='pranav') 
    {
      $demail=@$_GET['demail'];
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='pranav') 
    {
      $eid=@$_GET['eid'];
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='pranav') 
    {
      $name = $_POST['name'];
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'addqns' && $_SESSION['key']=='pranav') 
    {
      $n=@$_GET['n'];
      $eid=@$_GET['eid'];
      $ch=@$_GET['ch'];
