    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Javascript:void(0)"><b>MCQ TEST</b></a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li><a href="dashboard.php?q=4">Add Test</a></li>
                    <li><a href="dashboard.php?q=5">Remove Test</a></li>
                </ul>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php
                    ...
                    {
                        echo '<div class="row"><span class="title1" style="margin-left:40%;font-size:30px;color:#fff;"><b>Enter Test Details</b></span><br /><br />
                        <div class="col-md-3"></div><div class="col-md-6">   
                        <form class="form-horizontal title1" name="form" action="update.php?q=addtest"  method="POST">
                            <fieldset>
                ...
                <?php 
                    if(@$_GET['q']==5) 
                    {
                        ...
                        while($row = mysqli_fetch_array($result)) {
                            ...
                            <td><center><b><a href="update.php?q=rmtest&eid='.$eid.'" class="pull-right btn sub1" style="margin:0px;background:red;color:black"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></center></td></tr>';
                        }
                        $c=0;
                        echo '</table></div></div>';
                    }
